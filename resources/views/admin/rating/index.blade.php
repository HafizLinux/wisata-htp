...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="{{url('admin/rating/importexcel')}}" method="POST" enctype="multipart/form-data">
                ...
                <tr>
                    ...
                    <td>
                        <form action="#" method="POST">
                            <a class="btn btn-info btn-sm" href="{{url('admin/rating/show/'.$r->id)}}">Detail</a>

                            <a class="btn btn-warning btn-sm" href="{{url('admin/rating/edit/'.$r->id)}}">Ubah</a>
                            <!-- <button type="submit"  class="btn btn-danger btn-sm" name="proses" value="hapus"
                                                    onclick="return confirm('Anda yakin akan dihapus?')">Hapus</button>

                                                    <input type="hidden" name="idx" value=""> -->
                            <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModal{{$r->id}}">
                                Hapus
                            </button>
                            ...
                            <div class="modal fade" id="exampleModal{{$r->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            Apakah Anda Yakin akan menghapus data {{$r->nama}}?
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                            <!-- <button type="button" class="btn btn-primary">Save changes</button> -->
                                            <a class="btn btn-danger" href="{{url('admin/rating/delete/'.$r->id)}}">Hapus</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
