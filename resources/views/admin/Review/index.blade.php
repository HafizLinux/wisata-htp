                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <!-- <a href="{{url('admin/jabatan/create')}}" class="btn btn-primary btn-sm"> Tambah</a>
                                 -->
                                 <div class="card-header">
                            <a href="{{url('admin/review/export-review-pdf')}}" class="btn btn-success btn-sm" target="_blank">Eksport PDF</a>
                            </div>
                            </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a class="btn btn-danger" href="{{url('admin/review/delete/'.$u->id)}}">Hapus</a>
      </div>
    </div>
  </div>
</div>
